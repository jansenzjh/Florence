...
namespace Florence
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //Florence
            bundles.Add(new ScriptBundle("~/florence/florence").Include(
                        "~/Scripts/florence/florence.workshift.js",
                        "~/Scripts/florence/florence.project.js",
                        "~/Scripts/florence/florence.recruitment.js"));
            ...
            // verify 
            bundles.Add(new ScriptBundle("~/plugins/verify").Include(
                      "~/Scripts/plugins/verify/verify.notify.min.js"));
